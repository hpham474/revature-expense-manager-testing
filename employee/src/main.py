...
from src.service import AuthenticationService, ExpenseService
from src.api import auth_bp, expense_bp
...
def create_sample_data():
    ...
    from src.repository import DatabaseConnection, User, UserRepository
