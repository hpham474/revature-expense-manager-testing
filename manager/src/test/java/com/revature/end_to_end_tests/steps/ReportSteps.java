...
public class ReportSteps {
    ...
    public void aReportIsDownloadedAndAMessageIsShown(String arg0) {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
    ...
    public void aMessageContainingIsShown(String arg0) {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("the manager inputs {string} into the report employee id field")
    public void theManagerInputsIntoTheReportEmployeeIdField(String arg0) {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("the manager inputs {string} into the report category field")
    public void theManagerInputsIntoTheReportCategoryField(String arg0) {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @When("the manager inputs {string} into the start date field")
    public void theManagerInputsIntoTheStartDateField(String arg0) {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }

    @And("the manager inputs {string} into the end date field")
    public void theManagerInputsIntoTheEndDateField(String arg0) {
        // Write code here that turns the phrase above into concrete actions
        throw new PendingException();
    }
}
